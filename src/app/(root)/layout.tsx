...
import NotificationCookie from "@/components/ui/notification-cookie/notification-cookie";
import NotificationContainer from "@/components/ui/toast-container/toast-container";
...
export default function RootLayout({
  ...
  return (
    <>
      ...
      <NotificationCookie />
      <Headrer />
      <div className='relative flex flex-auto overflow-hidden bg-white pt-14 rounded-tl-4xl rounded-tr-4xl'>
