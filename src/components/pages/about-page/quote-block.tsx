          ...
          <div className='max-w-2xl'>
            ...
            >
              <motion.p variants={blockUp}>
                Наша команда опытных дизайнеров и разработчиков думает только об
                одном; работая над вашими идеями, чтобы вызвать улыбку на лицах
                ваших пользователей по всему миру. От проведения бренд-спринтов
                до UX-дизайна.
              </motion.p>
            </motion.div>
          </div>
