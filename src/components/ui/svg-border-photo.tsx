...
interface SvgBorderPhotoProps {
  img: string;
  variant: number;
}

const SvgBorderPhoto: React.FC<SvgBorderPhotoProps> = ({ variant, img }) => {
  if (variant === 3) {
    return (
          ...
          <g className='origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105'>
            <foreignObject width='719' height='680'>
              <Image
                ...
                style={{ color: "transparent", aspectRatio: "719 / 680" }}
                src={img}
              />
            </foreignObject>
          </g>
